...
<?else:?>
    <div class="search_input_detail mdi mdi-magnify">
	<input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" placeholder="поиск по сайту..."/>
        <input class="btn_search" type="submit" title="<?=GetMessage("SEARCH_GO")?>" value="<?=GetMessage("SEARCH_GO")?>" /> 
...
<?elseif(count($arResult["SEARCH"])>0):?>
    ...
    <div class="search_result">
        <span><?=GetMessage("SEARCH_RESULT_COUNT")?> <?echo $arResult["NAV_RESULT"]->SelectedRowsCount()?> </span>
        <!-- <div class="search-result-title"><?=$arResult["REQUEST"]["QUERY"]?></div> !-->
