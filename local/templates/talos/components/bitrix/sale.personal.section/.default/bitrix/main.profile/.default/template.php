...
<div class="bx_profile">    
	...
	<form method="post" name="form1" action="<?=$APPLICATION->GetCurUri()?>" enctype="multipart/form-data" role="form">
		...
		<div class="main-profile-block-shown" id="user_div_reg">
			...
			if (!in_array(LANGUAGE_ID,array('ru', 'ua')))
			{
				...
				<div class="form-group">
					<label class="main-profile-form-label col-xs-3 col-md-3 text-md-right" for="main-profile-title"><?=Loc::getMessage('main_profile_title')?></label>
			...
			?>
			<div class="form-group">
				<label class="main-profile-form-label col-xs-3 col-md-3 text-md-right" for="main-profile-name"><?=Loc::getMessage('NAME')?></label>
				<div class="col-md-12 col-xs-9">
					<input class="form-control" type="text" name="NAME" maxlength="50" id="main-profile-name" value="<?=$arResult["arUser"]["NAME"]?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="main-profile-form-label col-xs-3 col-md-3 text-md-right" for="main-profile-last-name"><?=Loc::getMessage('LAST_NAME')?></label>
				<div class="col-md-12 col-xs-9">
					<input class="form-control" type="text" name="LAST_NAME" maxlength="50" id="main-profile-last-name" value="<?=$arResult["arUser"]["LAST_NAME"]?>" />
				</div>
			</div>
			<div class="form-group">
				<label class="main-profile-form-label col-xs-3 col-md-3 text-md-right" for="main-profile-second-name"><?=Loc::getMessage('SECOND_NAME')?></label>
				<div class="col-md-12 col-xs-9">
			...
			<div class="form-group">
				<label class="main-profile-form-label col-xs-3 col-md-3 text-md-right" for="main-profile-email"><?=Loc::getMessage('EMAIL')?></label>
				<div class="col-md-12 col-xs-9">
			...
			if($arResult["arUser"]["EXTERNAL_AUTH_ID"] == '')
			{
				?>
				<div class="form-group">
					<label class="main-profile-form-label col-xs-3 col-md-3 text-md-right" for="main-profile-password"><?=Loc::getMessage('NEW_PASSWORD_REQ')?></label>
					<div class="col-md-12 col-xs-9">
				...
				<div class="form-group">
					<label class="main-profile-form-label main-profile-password col-xs-3 col-md-3 text-md-right" for="main-profile-password-confirm">
		...
		<div class="main-profile-form-buttons-block">
			<input type="submit" name="save" class="btn btn_blue main-profile-submit" value="<?=(($arResult["ID"]>0) ? Loc::getMessage("MAIN_SAVE") : Loc::getMessage("MAIN_ADD"))?>">
			&nbsp;
			<input type="submit" class="btn btn_white"  name="reset" value="<?echo GetMessage("MAIN_RESET")?>">
		</div>
	</form>
