...
window.JCCatalogElement = function (arParams)
{
	...
	this.treeEnableArrow = { display: '', cursor: 'pointer', color: '#2196f3'};
	this.treeDisableArrow = { display: '', cursor: 'default', color:'#bdbdbd'};
	this.sliderRowShowSize = 3;  // поменяла 4 на 3
	this.sliderEnableArrow = { display: '', cursor: 'pointer', color: '#2196f3'};
...
window.JCCatalogElement.prototype.BasketResult = function(arResult)
{
	...
	if ('OK' === arResult.STATUS)
	{
        ...
        strContent = '<div class="product-modal open"><span>Товар добавлен в корзину</span><a href="/personal/basket/" class="btn btn_blue">Оформить заказ</a></div>';
