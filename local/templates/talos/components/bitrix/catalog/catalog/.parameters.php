...
$arTemplateParameters['GROUPS_OF_PROP_IBLOCK_TYPE'] =  array(
		"PARENT" => "DETAIL_SETTINGS",
		"NAME" => GetMessage("GROUPS_OF_PROP_IBLOCK_TYPE"),
		"TYPE" => "LIST",
		"VALUES" => $arIBlockType,
		"REFRESH" => "Y",
);
$arTemplateParameters['GROUPS_OF_PROP_IBLOCK_ID'] = array(
		"PARENT" => "DETAIL_SETTINGS",
		"NAME" => GetMessage("GROUPS_OF_PROP_IBLOCK_ID"),
		"TYPE" => "LIST",
		"ADDITIONAL_VALUES" => "Y",
		"VALUES" => $arIBlock,
		"REFRESH" => "Y",
...
if (IsModuleInstalled("blog"))
{
	...
	if (isset($arCurrentValues['DETAIL_USE_COMMENTS']) && 'Y' == $arCurrentValues['DETAIL_USE_COMMENTS'])
	{
		...
		if (isset($arCurrentValues['DETAIL_BLOG_USE']) && 'Y' == $arCurrentValues['DETAIL_BLOG_USE'])
		{
			$arTemplateParameters['DETAIL_BLOG_HLBLOCK_PROP_CODE'] = array(
				'PARENT' => 'VISUAL',
				"NAME" => GetMessage("CP_BC_TPL_DETAIL_BLOG_HLBLOCK_PROP_CODE"),
				"TYPE" => "LIST",
				'PARENT' => 'VISUAL',
				"VALUES" => $arHighloadPropList
			);
			$arTemplateParameters['DETAIL_BLOG_HLBLOCK_CR_PROP_CODE'] = array(
				'PARENT' => 'VISUAL',
				"NAME" => GetMessage("CP_BC_TPL_DETAIL_BLOG_HLBLOCK_CR_PROP_CODE"),
				"TYPE" => "LIST",
				'PARENT' => 'VISUAL',
				"VALUES" => $arHighloadPropList
			);
...
$arTemplateParameters["DETAIL_PROPS_ANALOG"] = array(
    "PARENT" => "DETAIL_SETTINGS",
...
$arTemplateParameters["IBLOCK_ID_DOPINFO"] = array(
    "PARENT" => "DETAIL_SETTINGS",
    "NAME" => GetMessage("IBLOCK_ID_DOPINFO"),
    "TYPE" => "LIST",
    "VALUES" => $arIBlock
);
?>