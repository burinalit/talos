...
<div class="product_list">
    <div class="col-xs-12">
        <h2><span><?=GetMessage("TITLE")?></span></h2>
    </div>
<?
...
?>
        ...
        <div class="item col-md-3 col-sm-4 col-xs-6" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
            <div class="">
...
?>
		...
		{
			?>
		<!-- <div class="bx_catalog_item_controls no_touch">    онялнрперэ!!!!!!!!!
